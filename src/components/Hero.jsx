                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1
                            ...
                            initial="hidden"
                            animate="visible"
                            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16lg:text-8xl">Sushmitha Baliga B</motion.h1>
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <motion.img
                            ...
                            transition={{ duration: 1, delay: 1.2 }} src={profilePic} alt="Sushmitha Baliga B" />
                    </div>
                </div>
            </div>
        </div>
